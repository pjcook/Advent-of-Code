...
class Day13Tests: XCTestCase {
    let input = Input("Day13.input", .module, trimming: false).lines
    ...
    func test_part1_example() {
        let day = Day13()
        let input = Input("Day13_example1.input", .module).lines
        let position = day.part1(input)
    ...
    func test_part2_example() {
        let day = Day13()
        let input = Input("Day13_example2.input", .module).lines
        let position = day.part2(input)
