...
class Day11Tests: XCTestCase {
    ...
    func test_part1() throws {
        let day = Day11()
        let input = Input("Day11.input", .module).lines.compactMap({ $0.compactMap({ Character(extendedGraphemeClusterLiteral: $0) }) })
    ...
    func test_part1_v2() {
        let day = Day11_v2()
        let inputDict = Day11_v2.toDict(Input("Day11.input", .module).lines)
...
//    func test_part1_v3() {
//        let day = Day11_v3()
//        let input = Input("Day11.input", .module).lines
//        XCTAssertEqual(2243, day.part1(input))
//    }
...
//    }
    ...
    func test_part1_v4() throws {
        let day = Day11_v4()
        let input = Input("Day11.input", .module).lines.compactMap({ $0.compactMap({ Day11_v4.Option(rawValue: $0)! }) })
        XCTAssertEqual(2243, day.part1(input))
    }
    ...
    func test_parsing_to_dictionary() {
        let input = Day11_v2.toDict(Input("Day11.input", .module).lines)
        XCTAssertNotNil(input)
    }
}
